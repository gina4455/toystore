<?php   										// Opening PHP tag
	 ...
	 */
	 ...
	 function getToy(PDO $pdo, string $id) {
		$sql = "SELECT t.toynum, t.name AS toy_name, t.manid AS toy_manid, t.price, t.agerange, t.soldytd, t.numinstock, t.imgSrc, t.description,
					   m.manid AS man_manid, m.name AS man_name, m.Street, m.City, m.State, m.ZipCode, m.phone, m.contact				   
			FROM toy t
